...
При возникновении ошибки интерпретатор выводит сообщение с информацией об ошибке и её месте в коде, а для RuntimeError выводит ещё и текущий стек вызовов функций.
